...
Cambios:
- Implementé la corrección que expliqué en la segunda parte del examen: "Trigger" también actúa sobre "Vista" y "Tabla" tiene "Trigger"
- Añadí los atributos "evento activacion" y "momento activación" y sus respectivos tipos a la entidad "Trigger"
...
Cambios:
- Añadí el atributo "enunciado" a la entidad "Consulta"
